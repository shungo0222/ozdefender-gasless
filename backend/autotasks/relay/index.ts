...
const ForwarderAddress: string = "0x19D69a666bdcbE90b08570E5791F200953D7FE64";
const RegistryAddress: string = "0xb319eD06b14000d83736F8C9722df08e18E36E7a";
...
async function relay(forwarder: ethers.Contract, request: RelayRequest, whitelist?: string[]): Promise<ethers.ContractTransaction> {
...
async function handler(event: HandlerEvent): Promise<{ txHash: string }> {
  ...
  // Relay transaction!
  const tx = await relay(forwarder, signedRequest, [RegistryAddress]);
